...
function ProjectCard({
  ...
  return (
    ...
    >
      <motion.div
        className="sticky top-24 md:top-32 w-full rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-10 sm:p-14 md:p-20 flex flex-col items-center"
