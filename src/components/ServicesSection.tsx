...
const services = [
  ...
  },
  {
    number: "04",
    name: "Videography",
    desc: "Developing video-based work that focuses on mood, rhythm, and visual composition to communicate ideas clearly and effectively.",
  },
  {
    number: "05",
    name: "Web Design",
...
export function ServicesSection() {
  return (
    <section
      id="skills"
      className="bg-white rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32 relative z-[2]"
    >
      <h2
